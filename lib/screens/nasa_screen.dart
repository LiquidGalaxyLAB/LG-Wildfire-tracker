...
class _NasaApiPageState extends State<NasaApiPage> {
                        ...
                        child: ClipRRect(
                          ...
                          child: GoogleMap(
                            initialCameraPosition: const CameraPosition(
                              target: LatLng(10.7749, -122.4194),
                              // replace with your initial coordinates
                              zoom: 0.0,
                            ),
  ...
  Future<void> _goToCountry(String countryName) async {
    ...
    Coordinates cords =
        await GeoCode().forwardGeocoding(address: _selectedCountry.name);
    CameraPosition position = CameraPosition(
      bearing: 192.8334901395799,
      target:
          LatLng(cords.latitude ?? 40.712776, cords.longitude ?? -74.005974),
      zoom: 6.0,
      tilt: 59.440717697143555,
    );
